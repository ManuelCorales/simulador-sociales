  ...
  },
  {
    ...
    respuestas: [
      { texto: T('Lo salís a bancar y cubrís el costo a medias con él. Es por una buena causa.'), efectos: [
        { peso: 70, texto: T('Te quedás sin plata para cargar la SUBE. Vas a tener que saltar el molinete y correr. Quedás como el héroe de la gente y de tu amigo.'), stats: { fama: 12 } },
