  ...
  // ===================================================================
  {
    ...
    respuestas: [
      { texto: T('Te quedás hasta las mil y una hablando. Dios, Patria y Familia.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('En una de esas terminás casándote y se te resuelve la mitad de los problemas. Los compas sabrán entender. El coloquio salió como salió.'), stats: { fama: -5, conocimiento: -5 } },
      ]},
      { texto: T('Si es la indicada va a saber entender. Intercambian instagrams.'), gesto: 'der', efectos: [
        ...
        { peso: 30, cond: [{ tipo: 'stat', stat: 'guita', operador: '<', valor: 45 }],
          ...
          stats: { fama: -3 } },
        { peso: 70, texto: T('Se cortó el hechizo y no la viste nunca más. El coloquio salió bien, eso sí.'), stats: { politica: -4, conocimiento: 2 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Corrés el bondi.'), gesto: 'der', efectos: [
        { peso: 50, texto: T('Llegás, pero se te abrió la mochila y se te cayó todo. En el camino quedaron tus apuntes sobre Weber, Hobbes y Ofelia Fernández. Habrá que empezar de nuevo.'), stats: { conocimiento: -6, guita: -4 } },
        { peso: 50, texto: G(
          ...
          stats: { guita: -4, fama: 4, conocimiento: 5 } },
      ]},
      { texto: T('No te apurás. Ya llegará otro.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Estuviste tres horas chupando frío. Te quisieron robar y las chicas que laburan en Consti saltaron por vos. Les contaste lo que estudiabas y arrancaste una movida contra la represión policial en el barrio.'), stats: { guita: -4, fama: 4, politica: 6 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Le das plata.'), gesto: 'der', efectos: [
        { peso: 100, texto: T('El tipo te agradece y dice que quiere mostrarte algo. Te lleva al baño. Tenés miedo pero lo seguís. "Acercate", susurra. Mete la mano por debajo del cuello y se saca una máscara: ¡es Nisman!'), stats: { guita: -4, politica: 6 } },
      ]},
      { texto: T('No le creés.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('El tipo se aleja sin problema. Antes de doblar la esquina un francotirador lo fulmina con un tiro en la frente. No llegás a ver de dónde dispararon, pero hay humo en una ventana de San José.'), stats: { guita: 7, fama: -5, violencia: 5 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('A la biblioteca. Obviamente.'), efectos: [
        { peso: 100, texto: G('De tanto silencio te quedaste dormido. Llegaste tarde a la clase, pero la siesta te hizo bien: lo poco que estuviste participaste un montón.',
          ...
          stats: { conocimiento: 4, fama: 2 } },
      ]},
      { texto: T('Te encerrás en un aula vacía.'), efectos: [
        { peso: 100, texto: T('A los quince minutos entró un grupo para una clase y, como te dio vergüenza, te quedaste. Terminaste aprendiendo mucho sobre Martín Lutero.'), stats: { conocimiento: 7 } },
      ]},
      { texto: T('Agarrás una mesa en el foyer.'), efectos: [
        { peso: 100, texto: T('Mala luz y letra minúscula. Entraste a cursar sin ver un pito y encima no aprendiste un carajo.'), stats: { conocimiento: -5 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Elegís el tema difícil. No se trata solo de aprobar la materia.'), gesto: 'der', efectos: [
        { peso: 100, texto: T('Le dedicaste una banda de tiempo, quedó bien y le gustó a la cátedra.'), stats: { conocimiento: 10, fama: 3, guita: -2 } },
      ]},
      { texto: T('Elegís un tema papita que mucho no te interesa.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Lo hiciste el día anterior. Te sacaste la materia de encima y fuiste a final. En el medio te hiciste nuevos facuamigos igual de vagos que vos.'), stats: { conocimiento: -4, fama: 4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Dejás grabando el audio y te dormís. Si el profesor se da cuenta te podés ganar el odio de toda la cursada.'), efectos: [
        { peso: 50, texto: T('El profesor se da cuenta y te hace la vida imposible hasta el final. Recursás el cuatrimestre siguiente, pero en la otra cátedra.'), stats: { conocimiento: -6, fama: -5 } },
        { peso: 50, texto: T('El profesor se da cuenta pero le chupa un huevo. Es más: te ofrece un drive con los audios de todas las clases. Tu Samsung Pocket lo agradece y aprendés un montón.'), stats: { conocimiento: 8 } },
      ]},
      { texto: T('Te vas a comprar un café para remontarla.'), efectos: [
        { peso: 100, texto: T('El exquisito café de las máquinas del CeXso te hace efecto. La rompés. Y todo por 2000 pesos argensimios.'), stats: { conocimiento: 5, guita: -3 } },
      ]},
      { texto: T('Salís y hablás un rato con tu facuamigo que está haciendo tiempo.'), efectos: [
        { peso: 100, texto: T('Te cuenta que va a ser papá y que los pañales están muy caros. Volvés y le metés con todo a la clase: en un futuro esos pañales no se van a pagar solos.'), stats: { conocimiento: 5, fama: 3 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('Te hacés cargo y tirás un "mejor escuchemos la explicación del profesor".'), efectos: [
        { peso: 100, texto: G('Los demás te lo agradecen y el profesor también, aunque quedás medio chupamedias. El pibe no volvió a acotar nunca más en su vida.',
                              ...
                              'Los demás te lo agradecen y el profesor también, aunque quedás medio chupamedias. El pibe no volvió a acotar nunca más en su vida.'),
          stats: { conocimiento: 5, fama: -3 } },
      ]},
      { texto: T('No decís nada. La mejor forma de aprender es equivocándose.'), efectos: [
        { peso: 100, texto: T('A la clase siguiente el pibe dejó la materia.'), stats: { conocimiento: 4 } },
      ]},
      { texto: T('Agarrás el fierro caliente y le explicás lo que está diciendo mal.'), efectos: [
        { peso: 100, texto: T('Vos también lo decís mal. El profesor abandona la cátedra por estar rodeado de pelotudos. Ahora es influencer de tarot marxista.'), stats: { conocimiento: -5, fama: -5 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('"Para comer buena carne."'), efectos: [
        { peso: 100, texto: T('Boca, Perón y el Diego. La solución a la globalización es el nacionalismo.'), stats: { fama: 4, conocimiento: -4 } },
      ]},
      { texto: T('"Hay que expropiarlos a todos. Buscar un porqué me chupa un huevo."'), efectos: [
        { peso: 100, texto: T('Se notaron tus inclinaciones marxistas.'), stats: { politica: 7, conocimiento: -3 } },
      ]},
      { texto: T('"Para hacer fiestas gay con enanos."'), efectos: [
        { peso: 100, texto: T('Quisiste hacer un chiste y no salió. Los demás te miraron medio raro.'), stats: { fama: -5 } },
      ]},
      { texto: T('"Porque no saben hacer otra cosa que seguir el fetiche del dinero."'), efectos: [
        { peso: 100, texto: T('A la profe le cerró bastante tu respuesta y te lo hizo saber. Te motivaste y mejoraste tu desempeño.'), stats: { conocimiento: 8, politica: 4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Ya se va a curar. Solo es medio raro.'), efectos: [
        { peso: 100, texto: T('Mató a un cheto medio hippie de Comunicación Social.'), stats: { fama: -5, politica: -4, violencia: 12 } },
      ]},
      { texto: T('Lo denunciás con las autoridades de la facultad.'), efectos: [
        { peso: 100, texto: T('Lo echan pero ni se entera de que fuiste vos. Ya lo sabía todo el mundo.'), stats: { politica: 6, fama: 3 } },
      ]},
      { texto: T('Armás un linchamiento sorpresa para tu amigo. La historia se repite.'), efectos: [
        { peso: 100, texto: T('Se zarpan y lo matan. Mejor que ser oprimido.'), stats: { fama: 5, politica: -5, conocimiento: -5, violencia: 25 },
...

  {
    ...
    respuestas: [
      { texto: T('Das la cara y sos sincero.'), efectos: [
        { peso: 50, texto: T('Zafaste: te pusieron ausente y no quedó registro de nada.'), stats: { conocimiento: 2 } },
        { peso: 50, texto: T('Te comiste un uno redondo.'), stats: { conocimiento: -5, fama: -4 } },
      ]},
      { texto: T('Video motivacional de Locomotora Oliveras, un mango loco y un resumen de sesenta páginas.'), efectos: [
        { peso: 80, texto: T('Te fue como el orto, pero las ganas de comerte el mundo no te las saca nadie.'), stats: { conocimiento: -3, fama: 4 } },
        { peso: 20, texto: T('La cafeína llegó al cerebro y saliste de la caverna, así como decía Platón. Accediste a las Ideas y a partir de ahora creés en la Matrix. Te sacaste un 10.'), stats: { conocimiento: 13, fama: 3 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Me quedo libre pero conozco al Pity.'), gesto: 'der', efectos: [
        { peso: 100, texto: T('Homero tiene más valor social que toda la obra de Talcott Parsons. La foto con él se la mostrás hasta a los perros.'), stats: { fama: 8, conocimiento: -6 },
          aviso: { evento: 'av_pity', demora_min: 1, demora_max: 2 } },
      ]},
      { texto: T('Voy a cursar. No me queda otra.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('La próxima será. Cursaste con la cara hecha percha pero cursaste.'), stats: { conocimiento: 7, fama: -3 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('Los mandás al frente. Corrés el riesgo de que sea para un trabajo práctico.'), gesto: 'der', efectos: [
        { peso: 100, texto: G('Expusiste al CeXso y a las autoridades. Para el estudiantado quedaste como el espía del amor.',
          ...
          stats: { fama: 7, politica: -4 } },
      ]},
      { texto: T('No soy vigilante. Además hay que subir la tasa de fecundidad.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Sale a la luz por una foto: era un curso intensivo con aproximación realista a la educación sexual.'), stats: { politica: 6, fama: 2 } },
      ]},
    ],
  },
  ...
  // ===================================================================
  {
    ...
    respuestas: [
      { texto: T('Aceptás el laburo.'), gesto: 'der', efectos: [
        { peso: 75, texto: T('Ganás plata pero estás más cansado y perdés horas de cursada. Con lo recaudado comprás sanguchitos y café en el buffet.'), stats: { guita: 14, conocimiento: -6 } },
        { peso: 25, texto: T('Hacés una monografía para una materia contando el sistema de cooperación entre compañeros en el espacio de trabajo. Te ganaste el aplauso de los profesores.'), stats: { guita: 10, conocimiento: 2, fama: 3 } },
      ]},
      { texto: T('No lo aceptás.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Seguís con la tuya, pero el mes viene finito.'), stats: { guita: -5, conocimiento: 4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Te lo robás. Riesgo de que te vean.'), gesto: 'der', efectos: [
        { peso: 35, texto: T('Lo llevás a la clase, se lo mostrás, te lo firma y te suma al grupo de investigación.'), stats: { conocimiento: 10, fama: 5, politica: 4 },
          aviso: { evento: 'av_grupo_investigacion', demora_min: 1, demora_max: 3 } },
        { peso: 40, texto: T('Lo llevás a la clase, lo ve, le chupa un huevo y lo terminás vendiendo en Parque Centenario por la mitad de lo que sale nuevo.'), stats: { guita: 12, conocimiento: 2 } },
        { peso: 25, texto: T('Te vieron. El de seguridad te hizo vaciar la mochila delante de toda la fila.'), stats: { guita: -5, fama: -6 } },
      ]},
      { texto: T('No arriesgás: un libro de Ediciones Libertador y un pancho.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('El libro tiene la traducción hecha con los pies, pero algo entendiste. El pancho estaba bien.'), stats: { guita: -2, conocimiento: 4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Agarrás el trabajo. Si no se enteran no pasa nada.'), efectos: [
        { peso: 65, texto: T('Nadie se enteró. Cobraste como nunca en tu vida.'), stats: { guita: 16, politica: 4 } },
        { peso: 35, texto: T('Alguien te vio saliendo del búnker. Por ahora no dijeron nada.'), stats: { guita: 16, politica: 4 },
      ...
      { texto: T('Eso es inmoral y no condice con mis ideales. Mi oportunidad ya llegará.'), efectos: [
        { peso: 100, texto: T('Te quedaste sin la plata y con la conciencia limpia. Se paga con fideos.'), stats: { guita: -6, politica: 6 } },
      ]},
      { texto: T('Entrás y lo saboteás desde adentro. Héroe o villano, no hay lugar para los tibios.'), efectos: [
        { peso: 50, texto: T('Saliste con la plata y con el spot arruinado. Te convertiste en leyenda de pasillo.'), stats: { guita: 10, politica: 11, fama: 7 } },
        { peso: 50, texto: T('Te descubrieron y desencadenaste una campaña sucia contra toda la facultad.'), stats: { guita: 7, politica: -7, fama: -6, violencia: 8 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Entrás a trabajar en McDonalds. La beca puede esperar un año.'), efectos: [
        { peso: 100, texto: T('Ayudás a la familia. La beca quizá no se repita nunca.'), stats: { conocimiento: -7, guita: 16 } },
      ]},
      { texto: T('Entrás a trabajar y encima te matás estudiando para llegar a la beca.'), efectos: [
        { peso: 100, texto: T('Te recomendaron dedicación total y presentaste un trabajo flojo. Defraudaste a la cátedra.'), stats: { conocimiento: -5, fama: -6, guita: 10 } },
      ]},
      { texto: T('Te peleás con tu familia a muerte.'), efectos: [
        { peso: 100, texto: T('Te mudaste a lo de tu abuela, a tres horas de la facultad, y quemaste sus ahorros para subsistir.'), stats: { guita: -8, conocimiento: 10 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Las completás en una empresa.'), efectos: [
        { peso: 100, texto: T('En realidad te metieron precarizado en un call center. No aprendiste nada de la carrera, pero la experiencia te sirve para el CV. Te juran que cuando tengas el título te ponen en blanco.'), stats: { guita: 12, conocimiento: -6 } },
      ]},
      { texto: T('Hacés un taller de investigación con práctica territorial.'), efectos: [
        { peso: 100, texto: T('Hiciste un lindo informe pero te embarraste las zapatillas y, aunque las limpiaste con Vanish, se echaron a perder. Así es la calle, pibe.'), stats: { conocimiento: 10, guita: -4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Tirás el CV.'), gesto: 'der', efectos: [
        { peso: 30, texto: T('Quedaste. Ocho horas por día, pero algo se aprende.'), stats: { guita: 14, conocimiento: 4 } },
        { peso: 70, texto: T('No quedaste. Te dijeron que buscaban "más experiencia".'), stats: { guita: -4, conocimiento: 5 } },
      ]},
      { texto: T('No tirás. Lo bueno ya va a llegar.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Seguís usando tus horas libres para leer a Durkheim.'), stats: { conocimiento: 8 } },
      ]},
    ],
  },
  ...
  // --- El único punto del juego donde se puede dejar la carrera ---
  {
    ...
    respuestas: [
      { texto: T('Timbear en el sinoca de Puerto Madero. El rojo es tu mejor amigo.'), efectos: [
        ...
        { peso: 55, texto: T('Perdiste hasta la SUBE. Volviste caminando desde Puerto Madero.'), stats: { guita: -9, fama: -3 } },
      ]},
      { texto: T('A partir de ahora solo vas a comer empanadas de perro. Dicen que provocan amnesia.'), efectos: [
        { peso: 100, texto: T('Ahorrás una fortuna. El problema es que ya no te acordás de la unidad 3.'), stats: { guita: 10, conocimiento: -7 } },
      ]},
...

  {
    ...
    respuestas: [
      { texto: T('Borrás todo y te hacés pasar por el militante más fiel de todos.'), efectos: [
        { peso: 100, texto: T('Entraste. Comés todos los días y te odiás un poco cada mediodía.'), stats: { guita: 12, politica: -5 } },
      ]},
      { texto: T('Entrás pero se la boqueás a todos. En una de esas te comés algún bife.'), efectos: [
        { peso: 100, texto: T('Duraste tres semanas, pero la anécdota te la contás solo.'), stats: { guita: 7, fama: 5, politica: -4, violencia: 5 } },
      ]},
      { texto: T('No comprás con el CeXso. Completás el formulario con los datos de tu mayor enemigo.'), efectos: [
        { peso: 100, texto: T('Se lo dieron a él. Ahora te ve todos los días desde atrás del mostrador.'), stats: { guita: -5, fama: 4, politica: -3 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('El sentido de vivir es transitar la experiencia por sí misma. El título ya llegará.'), gesto: 'der', efectos: [
        { peso: 100, texto: T('Fue una noche irrepetible. Los libros los bajaste en PDF y nunca los abriste.'), stats: { guita: -8, conocimiento: -6, fama: 7 } },
      ]},
      { texto: T('Me parte al medio la nona. Lo hago más por ella que por mí.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Compraste hasta el último apunte. Le mandaste una foto y la puso en la heladera.'), stats: { conocimiento: 10, guita: 4 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('Te arriesgás para llegar al parcial y robás la bici.'), efectos: [
        { peso: 100, texto: G('Linchamiento masivo. Los sentimientos reprimidos por el pueblo contra el gobierno se esparcen sobre tu cabeza. La cana no se mete para salvarte. De tantas piñas quedás tonto y borrás de tu cabeza todo lo que viste el último cuatrimestre. Te roban hasta las zapatillas.',
          ...
          stats: { guita: -6, conocimiento: -11, violencia: 10 } },
      ]},
      { texto: T('Emprendés un discurso a viva voz demostrando todo lo que leíste.'), efectos: [
        { peso: 40, texto: G('La gente te sigue y te convertís en un líder genuino de la clase obrera.',
          ...
          stats: { fama: 8, conocimiento: 10, politica: 11 } },
        { peso: 60, texto: T('La gente te ignora y una señora al pasar te suelta un "zurdo de mierda" con garso incluido. Te tragás la frustración y mejorás la oratoria.'), stats: { fama: -5, conocimiento: 5 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Fumar.'), gesto: 'der', efectos: [
        { peso: 50, texto: T('Te relaja y potencia tus conocimientos. Al otro día entrás a rendir relajado e imparable.'), stats: { conocimiento: 10 } },
        { peso: 50, texto: T('Pegó mal y terminaste vomitando. Quedaste de cama toda la noche recordando a tu ex. Al otro día, en el examen, no pensabas en otra cosa que en cuando salían a tomar helado.'), stats: { conocimiento: -6, fama: -3 } },
      ]},
      { texto: T('Vas a la segura y lidiás con los nervios a la antigua.'), gesto: 'izq', efectos: [
        { peso: 50, texto: T('Al otro día no te fue tan bien por el cagazo. Aprobaste, pero vas a final.'), stats: { conocimiento: -4 } },
...

  {
    ...
    respuestas: [
      { texto: T('La curiosidad es más grande que vos. No podés negar tu instinto.'), efectos: [
        { peso: 50, texto: T('Dejaste todo por lo que te emocionaba. El titular te apadrinó. Aprobaste una materia de cuatro, pero tenés asegurado el carguito de profe de práctico para cuando te recibas. En una de esas escribís un libro.'), stats: { conocimiento: 10, politica: 7 } },
        { peso: 50, texto: G('Le metiste a full pero te pinchaste. Te diste cuenta de por qué no le daban tanta pelota en la academia. De igual manera estás orgulloso de vos: nunca habías sido tan valiente por algo en lo que creías.',
          ...
          stats: { politica: 6, conocimiento: 4 } },
      ]},
      { texto: T('La prioridad es aprobar. Cuanto antes te egreses, antes vas a poder investigar lo que quieras.'), efectos: [
        { peso: 80, texto: T('No lo retomaste y murió en el olvido.'), stats: { conocimiento: -5 } },
        { peso: 20, texto: T('Lo retomaste en el verano e hiciste una monografía. Lo bueno sabe esperar.'), stats: { conocimiento: 8 } },
      ]},
      { texto: T('Escribís un artículo reducido para un fanzine boludo que circula por la facultad.'), efectos: [
        { peso: 100, texto: T('Te interesa, pero dedicarle tanto esfuerzo te pareció al pedo. Igual lo leyó bastante gente.'), stats: { fama: 5 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Lo hacés para no dejarla en banda.'), efectos: [
        { peso: 100, texto: T('Capaz que ahora no, pero a la larga te puede acercar a los temas que te interesan.'), stats: { conocimiento: -4, fama: 5 } },
      ]},
      { texto: T('Le decís que sí pero lo pateás.'), efectos: [
        { peso: 100, texto: T('Lo olvidaste completamente. Era una prueba encubierta para recomendarte a una beca. La próxima será.'), stats: { conocimiento: -5, politica: -5 } },
      ]},
      { texto: T('Le decís que no, que en realidad no estás interesado.'), efectos: [
        { peso: 50, texto: T('La charla termina desencadenando en un tema que sí te interesa y te pasa el contacto de alguien que te podría ayudar. Te agradece por haber sido sincero.'), stats: { fama: 4, politica: 6 } },
        { peso: 50, texto: T('"En esta facultad todos hablan pero nadie quiere laburar", suelta, y se va. No te volvió a hablar ni para saludarte.'), stats: { fama: -5, politica: -4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Dos empanadas de carne y una de cheeseburger en el Rip Pizza de la esquina.'), efectos: [
        { peso: 50, texto: T('Te intoxicaste y te internaron. A la semana salió la noticia: estas cadenas usaban un combinado de carne perruna y humana para las empanadas. Perdiste un cuatrimestre entero.'), stats: { conocimiento: -11, fama: 7, guita: -4 } },
        { peso: 50, texto: T('Zafaste. Estaban baratas y llegaste al práctico con la panza llena y la cabeza en otro lado.'), stats: { guita: 4, conocimiento: -2 } },
      ]},
      { texto: T('Le hacés caso al señor misterioso de la puerta. Pancito relleno caliente.'), efectos: [
        { peso: 100, texto: G('A los cinco minutos el señor se ganó el Quini y te regala dos panes más. Te sentís Jesús: la suerte se reparte. Vas al práctico y la rompés todita. Te convertís en el favorito de la profe.',
          ...
          stats: { conocimiento: 8, guita: 7, politica: 6 } },
      ]},
      { texto: T('Comés en el comedor del centro.'), efectos: [
        { peso: 100, texto: T('La que atiende te empieza a preguntar por tu situación académica y te habla de la crisis nacional que ya conocés. No sabés cómo fugarte y te perdés todo el práctico. Ahora no sabés qué entra en el parcial.'), stats: { guita: -2, conocimiento: -6, politica: 7 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('Pegar trompadas. Riesgo de sanción.'), efectos: [
        { peso: 100, texto: G('Te suspendieron por boludo, pero sos el héroe del progresismo en las redes sociales. Perdiste un cuatrimestre.',
          ...
          stats: { fama: 8, politica: 7, conocimiento: -9, violencia: 15 } },
      ]},
      { texto: T('Vas al patio gay a rezar.'), efectos: [
        { peso: 100, texto: G('No sirvió de nada, pero te convertiste en mártir gay porque un estudiante de Comu te grabó.',
                              ...
                              'No sirvió de nada, pero te convertiste en mártir gay porque un estudiante de Comu te grabó.'),
          stats: { fama: 7, conocimiento: 5, politica: 6 } },
      ]},
...

  {
    ...
    respuestas: [
      { texto: T('Ponés la cara.'), gesto: 'der', efectos: [
        { peso: 50, texto: T('Tartamudeaste y no respondiste la pregunta del conductor más facho del país. Dejaste a los universitarios como unos boludos y el video recorrió todos los medios por tres días.'), stats: { fama: 7, politica: -5 } },
    ...
    respuestas: [
      { texto: T('Te parás adelante de la movilización y lo llevás de los pelos hasta la comisaría.'), efectos: [
        { peso: 100, texto: G('La fama es fama venga de quien venga. Te hiciste famoso: amado y odiado por ambos lados.',
          ...
          stats: { fama: 8, violencia: 10 } },
      ]},
      { texto: T('Te parás en el vértice y formás parte del grupo que lo atrapa.'), efectos: [
        { peso: 100, texto: T('Le gritaste alguna cosa pero no mucho más. Generaste confraternidad entre compañeros y terminaste haciendo amigos que respiran como vos el aire de la venganza social.'), stats: { politica: 7, fama: 4, violencia: 5 } },
      ]},
      { texto: T('Te desentendés del caso. Seguro son las feministas con sus cuentos.'), efectos: [
        { peso: 100, texto: T('En esta facultad no estudia nadie, pensás. Nadie te lo dijo en la cara, pero se notó.'), stats: { politica: -5, fama: -6 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('La plaza seca.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Te quedaste charlando con unos militantes que te invitaron al día siguiente a una actividad que te copó.'), stats: { politica: 7 } },
      ]},
...

  {
    ...
    respuestas: [
      { texto: T('"Revivamos el pos-porno."'), efectos: [
        { peso: 100, texto: T('Te ponés a hacer perfos y a flashearla artística. Hay gente que piensa que es ridículo, otros tienen miedo de que haya problemas con el gobierno, y otros se convierten en tus fans. Giro y sigo.'), stats: { fama: 8, politica: -4 } },
      ]},
      { texto: T('"Hagamos una revista provocadora."'), efectos: [
        { peso: 100, texto: T('Hacés tu propio fanzine y tus artículos generan controversia por el nivel de delirio: proponés arancelar los baños, poner molinetes en la biblioteca y suspender el buffet. Ahora las agrupaciones te dicen lumpen.'), stats: { politica: 7, fama: -5 } },
      ]},
      { texto: T('"Ser apadrinado por un profesor reconocido."'), efectos: [
        { peso: 100, texto: T('Te quedás charlando al final de las clases, te sumás al grupo de estudios y escribís un par de artículos.'), stats: { conocimiento: 10, fama: -5 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Sí, me anoto.'), gesto: 'der', efectos: [
        { peso: 50, texto: T('La rompiste toda. Te aplaudieron de pie y saliste con tres propuestas aprobadas.'), stats: { fama: 7, politica: 8, guita: -2 } },
        { peso: 50, texto: T('Dijiste cualquier cosa y encima te rascaste la verga delante de todos sin darte cuenta. Los memes van a quedar para la posteridad. Te defendés diciendo que es IA.'), stats: { fama: 8, politica: -5, conocimiento: -5 } },
      ]},
      { texto: T('No, dejar pasar.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('Te fuiste temprano y llegaste a hacer las compras.'), stats: { guita: 7, politica: -4, conocimiento: -3, fama: -3 } },
      ]},
    ],
  },
  ...
  // ===================================================================
  {
    ...
    respuestas: [
      { texto: T('Variante Universitaria.'), efectos: [
        { peso: 100, texto: T('Reuniones los martes y una caja de resistencia que funciona sorprendentemente bien.'), stats: { politica: 8, guita: 8 } },
      ]},
      { texto: T('La UElla.'), efectos: [
        { peso: 100, texto: T('Mucha calle, mucho megáfono y una cuenta de Instagram que crece rápido.'), stats: { politica: 8, fama: 5 } },
      ]},
      { texto: T('F.O.S.: Fulbito de los Obreros Sindicalistas.'), efectos: [
        { peso: 100, texto: T('Se juega los domingos y se lee a Gramsci los miércoles. No sobra un peso.'), stats: { politica: 8, conocimiento: 7, guita: -4 } },
      ]},
      { texto: T('No curtís ese mambo. Sos un intelectual de libre pensamiento.'), efectos: [
        { peso: 100, texto: T('Te movés tranqui piola sin berre. Nadie te va a buscar para nada.'), stats: { politica: -5, fama: -5, guita: 7 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Lo salís a bancar y cubrís el costo a medias. Es por una buena causa.'), efectos: [
        { peso: 70, texto: T('Te quedaste sin plata para cargar la SUBE y tuviste que saltar el molinete y correr. Quedaste como el héroe de la gente y de tu amigo.'), stats: { guita: -6, fama: 7 } },
        { peso: 30, texto: T('Caíste detenido y saliste en un spot publicitario de las fuerzas de seguridad.'), stats: { guita: -8, fama: -7, politica: 4 } },
      ]},
      { texto: T('Donde comen dos comen tres. Proponés repartir porciones más chicas.'), efectos: [
        { peso: 100, texto: T('Comieron todos. Nadie se fue con hambre y nadie puso un peso de más.'), stats: { politica: 8 } },
      ]},
      { texto: T('Mandás al frente a tu amigo. Creés que lo hizo a propósito para que pongas plata.'), efectos: [
        { peso: 100, texto: T('No volviste a sumarte a una movida así. Es para quilombo.'), stats: { fama: -9, politica: -4 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('Sacás una foto y la hacés pública.'), gesto: 'der', efectos: [
        { peso: 100, texto: G('La agrupación se desintegra en una marea roja de sangre y decepción. Quedás como el estudiante que hizo lo que nadie pudo, y todos te quieren de su lado.',
          ...
          stats: { politica: 11, fama: 5 } },
      ]},
      { texto: T('Entrás y te miran.'), gesto: 'izq', efectos: [
        { peso: 100, texto: T('"Vamos mitad y mitad y acá no pasó nada, muchachos." Te llenás los bolsillos, Carrió te convida un pucho, el Guillote te palmea la espalda y Lilia te invita un clona. Todos felices.'), stats: { guita: 16, politica: -7 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Les decís a todos que ya votaste.'), efectos: [
        { peso: 100, texto: T('Llegaste temprano a clase por primera vez en el cuatrimestre.'), stats: { conocimiento: 7, politica: -4 } },
      ]},
      { texto: T('Te quedás escuchando a cada uno.'), efectos: [
        { peso: 100, texto: T('Llegaste tarde a la cursada y te dolía la cabeza, pero ahora te conocen todos los apellidos.'), stats: { conocimiento: -5, politica: 8 } },
      ]},
...

  {
    ...
    respuestas: [
      { texto: T('Sos un estudiante comprometido con la ultra-seria militancia universitaria.'), efectos: [
        { peso: 100, texto: T('Acá es donde empieza el cambio del mundo. Esos dispensers de agua no se van a poner solos.'), stats: { politica: 8 } },
      ]},
      { texto: T('Te hacés el NPC y asentís con la cabeza.'), efectos: [
        { peso: 100, texto: T('En realidad estabas soñando con acariciarle la pelada a Foucault.'), stats: { politica: -4, conocimiento: 4 } },
      ]},
      { texto: T('Hacés notar tu molestia. Alto apático.'), efectos: [
        { peso: 100, texto: T('Una agrupación se enojó y sacó un reel: "Denunciamos un nuevo ataque fascista...".'), stats: { politica: -5, fama: -5 } },
      ]},
    ],
  },
    ...
    respuestas: [
      { texto: T('Te sumás a todas.'), efectos: [
        { peso: 100, texto: G('Hiciste 40 pasadas al hilo. Sucumbiste ante la alienación política y te convertiste en un autómata: ahora solo podés repetir el mismo discurso una y otra vez.',
          ...
          stats: { politica: 11, conocimiento: -6, fama: 5 } },
      ]},
      { texto: T('No comprás ni ahí.'), efectos: [
        { peso: 100, texto: T('Te fuiste a la biblioteca y aprovechaste las dos horas.'), stats: { fama: -5, politica: -4, conocimiento: 7 } },
      ]},
      { texto: T('Accedés a hacer las pasadas.'), efectos: [
        { peso: 100, texto: T('A la tercera pasada te confiesa que le chupa un huevo. Pela un porro y van a la plaza seca a escuchar a Los Redondos. Te revela que en realidad era Duki Green Son.'), stats: { fama: 7, politica: 4, conocimiento: -3 } },
      ]},
    ],
  },
  ...
  // ===================================================================
  {
    ...
    respuestas: [
      { texto: T('Silenciar el grupo'), efectos: [
        { peso: 100, texto: T('No contestaste nada. Igual todos saben.'), stats: { fama: -7, politica: -5 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Ponerla de foto de perfil'), efectos: [
        { peso: 100, texto: T('Te reconocen en el buffet. Ningún docente te toma en serio nunca más.'), stats: { fama: 7, conocimiento: -4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Mandárselo a tu vieja'), efectos: [
        { peso: 100, texto: T('Lo imprimió y lo puso en la heladera, al lado de las facturas.'), stats: { conocimiento: 8, fama: 4, politica: 4 } },
      ]},
    ],
  },

  {
    ...
    respuestas: [
      { texto: T('Ir a la citación'), efectos: [
        { peso: 100, texto: T('Nadie declaró nada y el expediente quedó dando vueltas. En el pasillo ya no te saluda casi nadie.'), stats: { fama: -6, politica: -4, violencia: 5 } },
      ]},
    ],
  },
];
...
const avisosDeFamilia = [
  {
    codigo: 'avf_fama_mas', familia: 'fama+', ilustracion: 'multitud', tipo: 'aviso', peso: 0,
    personaje: 'Un pibe de primero',
    titulo: T('Se corrió la bola'),
    texto: T('Un pibe que no conocés te para en el pasillo y te dice que sabe quién sos. Le da vergüenza y se va rápido. Un rato después te llega la captura: alguien lo contó en un grupo de cuatrocientas personas.'),
    respuestas: [
      { texto: T('Hacerte el humilde'), efectos: [
        { peso: 100, texto: T('Contestaste con un "nah, cualquier cosa" y quedó todavía mejor.'), stats: { fama: 4 } },
      ]},
    ],
  },
  {
    codigo: 'avf_fama_menos', familia: 'fama-', ilustracion: 'camara', tipo: 'aviso', peso: 0,
    personaje: 'Instagram',
    titulo: T('Salió una historia'),
    texto: T('Alguien subió una historia con tu cara y un texto que no vas a repetir en voz alta. La bajaron a las dos horas. Para entonces ya la habían visto todos los que importaban.'),
    respuestas: [
      { texto: T('Dejar que pase'), efectos: [
        { peso: 100, texto: T('No contestaste. Se va a hablar igual, pero menos.'), stats: { fama: -4 } },
      ]},
    ],
  },
  {
    codigo: 'avf_politica_mas', familia: 'politica+', ilustracion: 'afiche', tipo: 'aviso', peso: 0,
    personaje: 'Una agrupación',
    titulo: T('Te escribieron'),
    texto: T('Te escriben de una agrupación con la que nunca hablaste. Dicen que se enteraron de lo que hiciste y que "habría que juntarse". Tienen tu número, que vos no le diste a nadie.'),
    respuestas: [
      { texto: T('Contestar más tarde'), efectos: [
        { peso: 100, texto: T('Tardaste dos días a propósito. Volvieron a escribir igual.'), stats: { politica: 5, fama: 2 } },
      ]},
    ],
  },
  {
    codigo: 'avf_politica_menos', familia: 'politica-', ilustracion: 'facultad', tipo: 'aviso', peso: 0,
    personaje: 'La mesa de siempre',
    titulo: T('Dejaron de hablar'),
    texto: T('En la mesa de siempre dejan de hablar cuando pasás y retoman cuando te alejás. Nadie te dijo nada de frente, que es exactamente el problema.'),
    respuestas: [
      { texto: T('Seguir de largo'), efectos: [
        { peso: 100, texto: T('Seguiste de largo. Ellos también.'), stats: { politica: -5 } },
      ]},
    ],
  },
  {
    codigo: 'avf_guita_mas', familia: 'guita+', ilustracion: 'plata', tipo: 'aviso', peso: 0,
    personaje: 'Tu vieja',
    titulo: T('Llamada de tu vieja'),
    texto: T('Te llama tu vieja. Le contaron que andás con plata. No te pide nada, pero te lo dice de un modo que te va a durar toda la semana.'),
    respuestas: [
      { texto: T('Mandarle algo'), efectos: [
        { peso: 100, texto: T('Le mandaste sin que te pidiera. Es lo mínimo.'), stats: { guita: -5 } },
      ]},
    ],
  },
  {
    codigo: 'avf_guita_menos', familia: 'guita-', ilustracion: 'comida', tipo: 'aviso', peso: 0,
    personaje: 'Tesorería',
    titulo: T('Figurás con deuda'),
    texto: T('Te llega el mail: figurás con una deuda de la cuota del comedor. Son dos lucas y no las tenés. Lo peor no es la plata, es tener que ir a explicarlo a una ventanilla.'),
    respuestas: [
      { texto: T('Ir a pedir prórroga'), efectos: [
        { peso: 100, texto: T('Te la dieron. La señora de la ventanilla te trató mejor de lo que esperabas.'), stats: { guita: -3, politica: 2 } },
      ]},
    ],
  },
  {
    codigo: 'avf_conocimiento_mas', familia: 'conocimiento+', ilustracion: 'profesor', tipo: 'aviso', peso: 0,
    personaje: 'El titular de cátedra',
    titulo: T('Mail de dos líneas'),
    texto: T('El titular te manda un mail de dos líneas. Dice que le comentaron algo que dijiste y que quiere charlar. No aclara de qué, que es la forma en que te enterás de que era importante.'),
    respuestas: [
      { texto: T('Ir a la charla'), efectos: [
        { peso: 100, texto: T('Habló él veinte minutos y vos cuatro. Las cuatro fueron buenas.'), stats: { conocimiento: 5, fama: 2 } },
      ]},
    ],
  },
  {
    codigo: 'avf_conocimiento_menos', familia: 'conocimiento-', ilustracion: 'libro', tipo: 'aviso', peso: 0,
    personaje: 'La ayudante de TP',
    titulo: T('Te devolvieron el parcial'),
    texto: T('La ayudante te devuelve el parcial con una sola anotación en el margen, escrita chiquita: "esto no es lo que dice el texto". Abajo está la nota, que es peor que la anotación.'),
    respuestas: [
      { texto: T('Aceptarlo'), efectos: [
        { peso: 100, texto: T('Tenía razón y las dos partes lo sabían.'), stats: { conocimiento: -4 } },
      ]},
    ],
  },
  {
    codigo: 'avf_violencia', familia: 'violencia+', ilustracion: 'alerta', tipo: 'aviso', peso: 0,
    personaje: 'Dirección de carrera',
    titulo: T('Te citaron'),
    texto: T('Te citan de la Dirección de carrera. No es una charla informal: hay tres personas del otro lado del escritorio y una toma notas. Preguntan por algo que pasó y por dónde estabas vos.'),
    respuestas: [
      { texto: T('Decir que no te acordás'), efectos: [
        { peso: 100, texto: T('Anotaron eso también.'), stats: { politica: -4, fama: -3 } },
      ]},
    ],
  },
];
